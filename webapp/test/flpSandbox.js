		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EHSM Portal",
									"targetURL": "#maheshehsmportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"maheshehsmportal-display": {
								"semanticObject": "maheshehsmportal",
								"action": "display",
								"description": "SAP - Environment Health and Safety Management Portal",
								"title": "EHSM Portal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=maheshehsmportal",
									"url": sap.ui.require.toUrl("maheshehsmportal")
								}
							}
						}
					}
